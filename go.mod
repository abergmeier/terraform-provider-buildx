...
require github.com/hashicorp/terraform-plugin-go v0.9.0
...
replace github.com/docker/buildx v0.7.1 => github.com/abergmeier/buildx v0.0.0-20220213205936-8cc4f0908061

//replace github.com/hashicorp/terraform-plugin-framework v0.8.0 => ../terraform-plugin-framework
